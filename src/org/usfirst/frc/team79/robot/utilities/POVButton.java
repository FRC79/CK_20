...
public class POVButton extends Trigger {
	 ...
	 *            the command to start
	 */
	public void whileActive(final Command command, int value) {
		new ButtonScheduler() {
	 ...
	 *            the command to start
	 */
	public void whenInactive(final Command command, int value) {
		new ButtonScheduler() {
	 ...
	 */
	public void toggleWhenActive(final Command command, int value) {
		new ButtonScheduler() {
	 ...
	 */
	public void cancelWhenActive(final Command command, int value) {
		new ButtonScheduler() {
